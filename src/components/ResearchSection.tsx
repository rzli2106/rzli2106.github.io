...
const researchProjects = [
  {
    ...
    doi: "10.1109/ISEC61299.2025.10943985",
  ...
  },
  {
    ...
    doi: "10.1109/UEMCON62879.2024.10754773",
  ...
  },
  {
    ...
    doi: "10.1109/ICIR62380.2024.00021",
  ...
  },
  {
    ...
    doi: "10.1109/ISEC61299.2025.10943762",
      ...
      <div className="container px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
          ...
          <div className="md:col-span-2 lg:col-span-2 glass-card rounded-xl p-8 hover-lift group relative overflow-hidden">
            ...
            {researchProjects[0].doi && (
              <a
                href={`https://doi.org/${researchProjects[0].doi}`}
                target="_blank"
